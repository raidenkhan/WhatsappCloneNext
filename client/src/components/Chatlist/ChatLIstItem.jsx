...
function ChatLIstItem({data,isContactsPage=false}) {
  ...
  onClick={handleContactClick}>
    <div className="min-w-fit px-5 pt-2 pb-1 ">
      ...
      <div className="flex justify-between">
        ...
        <div className="flex border-b border-conversation-border pb-2 pt-1 pr-2 ">
          <div className="flex justify-between w-full">
            <span className="text-secondary line-clamp-1 text-sm">{isContactsPage ? data?.about || "\u00a0" : <div className="flex items-center gap-1 max-w-[200px]
            sm:max-w-[250px] mdx:max-w-[300px] lg:max-w-[200px] xl:max-w-[300px]">
              {
              ...
              { 
                data.type ==="image" && <span className="flex gap-1 items-center"><FaCamera className="text-panel-header-icon"/> Photo</span>
              }
              </div>}</span>
              {
