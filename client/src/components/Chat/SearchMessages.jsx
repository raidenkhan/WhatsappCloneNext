...
if(searchTerm){
  ...
  return <div className="z-10 border-conversation-border border-1 w-full bg-conversation-panel-background ">
    ...
    <div className="overflow-auto custom-scrollbar h-full">
      ...
      <div>
        <input type="text"  placeholder="search Message " className="bg-transparent text-sm focus:outline-none text-white w-full"
        value={searchTerm}
      ...
      <div className="flex justify-center h-full flex-col ">
        ...
        <div className="flex flex-col w-full h-full">
          {
            SearchMessages.map((message)=>(<div className="flex cursor-pointer flex-col justify-center hover:bg-background-default-hover w-full px-5 border-b-[0.1px] border-secondary py-5">
