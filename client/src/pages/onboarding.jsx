...
useEffect(()=>{
  ...
  return <div className="bg-panel-header-background h-screen w-screen text-white flex flex-col items-center justify-center">
    ...
    ' alt="whatsapp" height={300} width={300}/>
    ...
    <div className="flex gap-6 mt-5">
      <div className="flex flex-col items-center justify-center mt-5 gap-6">
        ...
        <div className="flex items-center justify-center">
          <button className="flex items-center justify-center gap-7 bg-search-input-container-background p-5 rounded-lg" onClick={onBoardUser}>Create Profile</button>
        </div>
      </div>
      <div>
